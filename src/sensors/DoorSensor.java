...
public class DoorSensor extends Sensor implements Runnable {
    ...
    private float currentDoorState = 0;
...
//of a percentage of the screen height
            ...
            messageWin.writeMessage("   Initial Door Set:: " + currentDoorState);
/**
 * ******************************************************************
...
// Post the current temperature
                postEvent(evtMgrI, DOOR, currentDoorState);
                messageWin.writeMessage("Current door state is::  " + currentDoorState + " .");
...
// output of the temperature as it would in reality.
                ...
                for (int i = 0; i < qlen; i++) {
                    ...
                    if (evt.getEventId() == DOOR_SENSOR) {
                        if (evt.getMessage().equalsIgnoreCase(DOOR_ON)) // heater on
                        {
                            currentDoorState = 0;
                        } // if
                        if (evt.getMessage().equalsIgnoreCase(DOOR_OFF)) // heater off
                        {
                            currentDoorState = 1;
                        } // if
                    } // if
